<template>
  ...
  <div class="workbenches_container">
    ...
    <div class="project-progress-bar-container">
      <span class="progress-label">当前项目进度：</span>
      <div class="progress-bar-bg">
        <div class="progress-bar-fg" style="width: 68%"></div>
...
import SampleModelConstruction from "./module/SampleModelConstruction.vue";
import PMA from "./projectMultiAgent.vue";
import PCA from "./projectChatAgenr.vue";
import SingleCellSequencing from "./module/SingleCellSequencing.vue";
